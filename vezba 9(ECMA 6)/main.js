...
let array = a.map(function(number){
    return number + 2;
});
console.log(array);
...
let c = [4, 6, 11, -9, 2.1], d =2;
const increaseEachElement = (array, number = 1) => array.map((item)=> item + number);

console.log(increaseEachElement(c,d))
